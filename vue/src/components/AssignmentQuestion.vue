        ...
        <div v-for="(item, questionIndex) in assignment.questions" :key="questionIndex" focusable>
            ...
            <form>
                <div>
                    ...
                    <textarea label="Question" v-model="item.question"></textarea>
                    <label>Points:</label>
                    <textarea type="number" label="Points" v-model.number="item.points"></textarea>
                </div>
                <div v-for="(answer, answerIndex) in item.answers" :key="answerIndex">
                    <label>Answer {{answerIndex + 1}}:</label>
                    <textarea label="Answer" v-model="answer.answer"></textarea>
                    <label>Correct?</label>
